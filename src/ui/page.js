  ...
  <footer class="page-footer">
    <div class="footer-content">
      <div class="footer-links">
        <a href="https://github.com/qtingdev/cf-2fa" target="_blank" rel="noopener noreferrer" class="footer-link">
        ...
        <a href="https://github.com/qtingdev/cf-2fa/issues" target="_blank" rel="noopener noreferrer" class="footer-link">
          反馈问题
        </a>
        <span class="footer-separator">•</span>
        <a href="https://github.com/qtingdev/cf-2fa/blob/main/README.md" target="_blank" rel="noopener noreferrer" class="footer-link">
          使用文档
        </a>
      </div>
